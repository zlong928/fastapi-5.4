    ...
    <QueryClientProvider client={queryClient}>
      <Layout>
        <Routes>
          ...
          <Route path="/tags" element={<ProtectedRoute><Navigate to="/knowledge" replace /></ProtectedRoute>} />
          <Route path="/statistics" element={<ProtectedRoute><StatisticsPage /></ProtectedRoute>} />
          <Route path="/settings" element={<ProtectedRoute><SettingsPage /></ProtectedRoute>} />
          <Route path="/tools" element={<ProtectedRoute><Navigate to="/" replace /></ProtectedRoute>} />
          <Route path="/books" element={<ProtectedRoute><Navigate to="/notes" replace /></ProtectedRoute>} />
